...
$config['admin_group'] = 'super-admin';
$config['regular_admin_group'] = 'admin';
$config['teacher_group'] = 'utbildare';
$config['extended_teacher_group'] = 'utökad utbildare';
$config['default_group'] = 'användare';
...
$config['maximum_login_attempts'] = 4;
